<template>
  <section class="section-hero section-shaped my-0">
    ...
    <div
      class="container shape-container d-flex align-items-center entrance-slide"
    >
      <div class="col px-0">
...
.section-hero .shape {
  -webkit-animation: appear 1.5s cubic-bezier(0.25, 0.46, 0.45, 0.94) both;
