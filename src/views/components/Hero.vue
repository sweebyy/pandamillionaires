            ...
            <div class="col px-0">
                <div class="row justify-content-center align-items-center">
                    <div class="col-lg-7 text-center">
                        <img src="img/brand/red-panda.png" style="width: 420px;" class="img-fluid">
                        <p class="lead text-white mt-4 mb-5" style="text-align:justify;">Pandamillionnaires à pour but de reverser 100% des royalties des marketplaces secondaires envers sa communauté, par différents systèmes notamment pour buyback le floor price, où distribuer en système d’airdrop à tous les holders d’un Panda.</p>
